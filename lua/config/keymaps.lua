...
map("n", "<leader>w<Left>", "<C-w>h", { desc = "Move to left window" })
map("n", "<leader>w<Down>", "<C-w>j", { desc = "Move to bottom window" })
map("n", "<leader>w<Up>", "<C-w>k", { desc = "Move to top window" })
map("n", "<leader>w<Right>", "<C-w>l", { desc = "Move to right window" })
